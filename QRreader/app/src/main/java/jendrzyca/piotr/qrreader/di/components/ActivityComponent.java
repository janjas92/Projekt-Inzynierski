...
import jendrzyca.piotr.qrreader.activities.MainActivity;
 ...
 */
@PerActivity
@Component(modules = {DatabaseModule.class, BitmapCacheModule.class}, dependencies = ApplicationComponent.class)
